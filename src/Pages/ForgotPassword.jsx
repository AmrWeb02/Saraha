...
const ForgotPassword = () => {
    ...
    <Stepper activeStep={stepNumber} sx={{width:"100%",}}>
        ...
        {stepNumber===3 &&  <div style={{marginBottom:"20px", textAlign:"center"}}><h3 style={{margin:"60px 0",textAlign:"center"}}>Your password has been successfully reset. You can now log in with your new password.</h3>
