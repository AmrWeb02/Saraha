...
const InputHandler = (e) =>{
  ...
  return (
    ...
    <Card sx={{position:"relative",backgroundColor:"primary.light", display:"flex", flexDirection:"column", justifyContent:"center",alignItems:"center", padding:"40px 0", width: {xs:"300px",sm:"600px", md:"800px"} }}>
        {stepNumber===1 && <ResetGuide imglogo ={forgot} title="Forgot Password" subtitle="We'll send you reset instructions through email" label="Reset">
        ...
        {stepNumber===2 && <ResetGuide imglogo ={mail} title="Password Reset" subtitle="Put the code we sent to your email" label="Continue">
            <OtpInput data={resetData} setData = {SetResetData}/>
        </ResetGuide>}
        {stepNumber===3 && <ResetGuide imglogo ={lock} title="Set new password" label="Reset Password">
