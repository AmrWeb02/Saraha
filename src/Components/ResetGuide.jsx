...
const ResetGuide = ({data, setData, step, setStep, imglogo, title, subtitle, label, children}) => {
  ...
  return (
    ...
    const sendEmail = async (data, setStep,setData) =>{
      try{
          const response = await fetch('https://free.saraha.site/auth/forget-password1',{
              method: "PATCH",
    ...
    const sendOTP = async (data, setStep,token) =>{
      ...
      try{
        const response = await fetch('https://free.saraha.site/auth/forget-password2',{
          method: "PATCH",
          headers: {
            "Authorization" : token,
            "Content-type":"application/json",
    ...
    const sendPass = async (data, setStep, token) =>{
      try{
        const response = await fetch('https://free.saraha.site/auth/forget-password3',{
          method: "PATCH",
          headers: {
            "Authorization" : token,
            "Content-type":"application/json",
